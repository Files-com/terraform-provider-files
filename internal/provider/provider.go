...
func (p *filesProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewAiAssistantPersonalityDataSource,
		NewAiTaskDataSource,
		NewApiKeyDataSource,
		...
		NewDesktopConfigurationProfileDataSource,
		NewEventChannelDataSource,
		NewEventDeliveryAttemptDataSource,
		NewEventRecordDataSource,
		NewEventSubscriptionDataSource,
		NewEventTargetDataSource,
		NewExpectationDataSource,
		NewExpectationEvaluationDataSource,
		NewExpectationIncidentDataSource,
...
func (p *filesProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewAiAssistantPersonalityResource,
		NewAiTaskResource,
		NewApiKeyResource,
		...
		NewDesktopConfigurationProfileResource,
		NewEventChannelResource,
		NewEventSubscriptionResource,
		NewEventTargetResource,
		NewExpectationResource,
		NewFileResource,
		...
		NewHolidayCalendarResource,
		NewIntegrationCentricProfileResource,
		NewKeyLifecycleRuleResource,
		NewLockResource,
		NewMessageResource,
		NewMessageCommentResource,
		NewMessageCommentReactionResource,
		NewMessageReactionResource,
		NewMetadataCategoryResource,
		NewNotificationResource,
		NewPartnerResource,
		NewPartnerChannelResource,
		NewPartnerChannelTemplateResource,
		NewPartnerSiteRequestResource,
		NewPermissionResource,
		NewProjectResource,
		NewPublicKeyResource,
		NewRemoteMountBackendResource,
		NewRemoteServerResource,
		NewRemoteServerCredentialResource,
		NewRequestResource,
		NewScheduledExportResource,
		NewSecretResource,
		...
		NewSyncResource,
		NewUserResource,
		NewUserAdditionalEmailRecipientResource,
